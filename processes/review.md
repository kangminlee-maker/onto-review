...
1. **학습 저장**: 8인 전원의 학습을 저장합니다. `process.md`의 "학습 저장 규칙"을 따릅니다. 쟁점 토론을 거친 경우, 토론 과정에서 발생한 학습도 포함합니다. **학습 데이터 수집은 팀 종료 이전에 완료해야 합니다.**

2. **Team 종료**: team lead가 8인 전원에게 shutdown_request를 보냅니다. 전원 종료 후 TeamDelete로 팀을 정리합니다.
